...
public class XListViewFooter extends LinearLayout {
	...
	public void setState(int state) {
		...
		mHintView.setVisibility(View.INVISIBLE);
		if (state == STATE_READY && mIsShowText) {
			...
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(footerHintNormalText);
		}
	}
	...
	private void initView(Context context,int layoutID) {
		mContext = context;
		LinearLayout moreView = (LinearLayout)LayoutInflater.from(mContext).inflate(layoutID, null);
		addView(moreView);
		...
		footerHintNormalText = getResources().getString(R.string.xlistview_footer_hint_normal);
	}
}
